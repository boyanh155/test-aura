...
const Footer = (props: Props) => {
  return (
    <div className="w-full bg-neutral-800 flex justify-center py-8 text-neutral-0 gap-10 items-center">
      {/* cashback */}
      <div className="flex gap-3 items-center">
        ...
        <p className="text-light text-neutral-400">Instant cashback</p>
        <p className="font-semibold ">10%</p>
      </div>
      {/* how it work */}
      <div className=" border-[0.5px] tracking-widest border-neutral-400 uppercase rounded-full px-7 py-3">
        how it works
      </div>
    </div>
  );
